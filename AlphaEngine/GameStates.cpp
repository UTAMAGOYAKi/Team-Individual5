...
s32 pX{};
s32 pY{};
bool alchemy_mode{}, combination{};
float spell_pos{}, item_one_pos{}, item_two_pos{};

float fire_x{}, fire_y{}; // struct for this in future
bool fire_to_mouse{};

float poison_x{},poison_y{};
bool poison_to_mouse{};
...
void GameStateAlchemiceInit() {
	...
	combination = false;
	spell_pos = outside;
	item_one_pos = (spell_pos - 100);
	item_two_pos = (spell_pos + 100);
